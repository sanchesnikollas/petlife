...
export default function Welcome({ onContinue }) {
  ...
  return (
    <div className="min-h-screen bg-surface flex flex-col relative overflow-hidden">
      ...
      <div className="absolute top-0 right-0 w-72 h-72 rounded-full bg-primary/5 -translate-y-1/3 translate-x-1/3" />
      <div className="absolute bottom-20 left-0 w-56 h-56 rounded-full bg-accent/5 translate-y-1/3 -translate-x-1/3" />
